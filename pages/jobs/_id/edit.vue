    ...
    <div class="mt-10 flex justify-center">
        ...
        <div class="mb-10">
           ...
           <div class="mb-4">
             ...
             :class="{ 'border-red-500': errors['input.job_title'] }" v-model="me.jobs[0].job_title">
           ...
           <div class="mb-4">
             ...
             class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500': errors['input.job_location']}" v-model="me.jobs[0].job_location">
           ...
           <div class="mb-4">
             ...
             class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500':  errors['input.job_link']}" v-model="me.jobs[0].job_link">
           ...
           <div class="mb-4">
             ...
             <v-select class="border-2 border-gray-200 rounded-lg" inputId="tags" label="title" :reduce="tag => tag.id" :options="tags" multiple v-model="me.jobs[0].tags" :class="{ 'border-red-500':  errors['input.tags.connect']}"></v-select>
           ...
           <div class="mb-4">
             ...
             class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500': errors['input.company_name']}" v-model="me.jobs[0].company_name">
            ...
            <div class="mb-4">
             ...
             class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500': errors['input.company_logo']}" v-model="me.jobs[0].company_logo">
           <div class="text-sm text-red-500 mt-1" v-if="errors['input.company_logo']">
               {{ errors['input.company_logo'][0] }}
            </div>
           </div>
           <div class="mb-4">
               <input type="checkbox" name="highlighted" id="highlighted" v-model="me.jobs[0].highlighted"><label for="highlighted">Highlighted listed</label>
           </div>
           <div class="mb-4">
           ...
           <button type="submit" class="p-4 bg-blue-500 text-white font-medium rounded-lg">Edit Listing</button>
        </form>
    </div>
</template>
<script>
