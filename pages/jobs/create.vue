    ...
    <div class="mt-10 flex justify-center">
        ...
        <div class="mb-10">
           ...
           <div class="mb-4">
             ...
             <input type="text" name="job_title" id="job_title" class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" 
             :class="{ 'border-red-500': errors['input.job_title'] }" v-model="form.job_title">
           ...
           <div class="mb-4">
             ...
             class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500': errors['input.job_location']}" v-model="form.job_location">
           ...
           <div class="mb-4">
             ...
             class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500':  errors['input.job_link']}" v-model="form.job_link">
           ...
           <div class="mb-4">
             ...
             <v-select class="border-2 border-gray-200 rounded-lg" inputId="tags" label="title" :reduce="tag => tag.id" :options="tags" multiple v-model="form.tags" :class="{ 'border-red-500':  errors['input.tags.connect']}"></v-select>
           ...
           <div class="mb-4">
             ...
             class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500': errors['input.company_name']}" v-model="form.company_name">
            ...
            <div class="mb-4">
             ...
             class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500': errors['input.company_logo']}" v-model="form.company_logo">
           <div class="text-sm text-red-500 mt-1" v-if="errors['input.company_logo']">
               {{ errors['input.company_logo'][0] }}
            </div>
           </div>
           <div class="mb-4">
               <input type="checkbox" name="highlighted" id="highlighted" v-model="form.highlighted"><label for="highlighted">Highlighted listed</label>
           </div>
           <div class="mb-4">
           ...
           <div class="mb-10">
                 ...
                 <div class="bg-gray-400 p-6 rounded-lg">
                    <div class="mb-4">
                        ...
                        class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.user.create.email']}" v-model="form.user_email">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" 
                    ...
                    <div class="mb-4">
                        ...
                        class="bg-gray-200 border-2 border-gray-200 rounded-lg w-full h-10 px-4" :class="{ 'border-red-500':  errors['input.user.create.password']}" v-model="form.user_password">
